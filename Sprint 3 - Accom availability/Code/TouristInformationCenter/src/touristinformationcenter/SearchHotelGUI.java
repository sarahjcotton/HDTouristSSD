...
public class SearchHotelGUI extends javax.swing.JFrame {
    ...
    private void cboHotelsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboHotelsActionPerformed
        ...
        //  aResults = tourist.searchForAccommodation(cboHotels.getSelectedItem().toString(), "Empty");
            ...
            if (a.getName().equals(htNa)) { //if current accommodation getName = cboName
                ...
                for (Room r : a.getRooms()) { //loop through rooms in that accommodation to find availalitlty for each room.
                   ...
                   boolean sun = r.available[6];
                    model.addRow(new Object[]{rmNo, rmTy, mon, tue, wed, thu, fri, sat, sun}); //add data to table model
                }
            }
        }
        JFrame f = new JFrame();
